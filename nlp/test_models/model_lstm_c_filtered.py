...
lstm_forward2 = layers.LSTM(300, activation='relu',return_sequences=True, dropout=0.2, recurrent_dropout=0.2)(lstm_forward1)
#lstm_forward1 = layers.LSTM(100, activation='relu', dropout=0.2, recurrent_dropout=0.2)(word_embedding)
lstm_forward3 = layers.LSTM(300, activation='relu',dropout=0.2, recurrent_dropout=0.2)(lstm_forward2)
...
lstm_backward2 = layers.LSTM(300,activation='relu', return_sequences=True, dropout=0.2, recurrent_dropout=0.2)(lstm_backward1)
lstm_backward3 = layers.LSTM(300,activation='relu', dropout=0.2, recurrent_dropout=0.2)(lstm_backward2)
#con_layer1 = layers.Concatenate(axis=1)([lstm_forward1, lstm_backward1])
con_layer2 = layers.Concatenate(axis=1)([lstm_forward3, lstm_backward3])
...
droup_out2 = layers.Dropout(.5)(con_layer2)
...
checkpoint_filepath = 'model_c-{epoch:02d}-{val_acc:.2f}.hdf5'
...
model.fit(input_sample, out_sample_array,epochs=50,batch_size = 60,validation_split = 0.1,callbacks=[checkpoint])
