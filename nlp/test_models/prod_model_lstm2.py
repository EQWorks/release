...
def mdoel_build(embedd_dim,sentence_len,neuron_size,train_files,test_files,outpath, model_name,seq_range,token_len_filter,lr,skip_iter):
    ...
    lstm_forward1 = layers.LSTM(neuron_size, activation='relu', dropout=0.2,return_sequences=True, recurrent_dropout=0.2)(word_embedding)
    lstm_forward2 = layers.LSTM(neuron_size, activation='relu', dropout=0.2, recurrent_dropout=0.2)(lstm_forward1)
    lstm_backward1 = layers.LSTM(neuron_size,activation='relu',dropout=0.2, return_sequences=True, recurrent_dropout=0.2,go_backwards = True)(word_embedding)
    lstm_backward2 = layers.LSTM(neuron_size, activation='relu', dropout=0.2, recurrent_dropout=0.2)(lstm_backward1)
    ...
    droup_out3 = layers.Dropout(.5)(dense_layer2)
